...
<div class="pb-popup popup-newsletter gdz-popup-overlay" style="display: none;">
	<div class="gdz-popup">
		<div class="gdz-popup-content">
			...
			{/if}
			<p class="desc">{l s='Subscribe to the ZEFA eCommerce newsletter to receive timely updates from your favorite products' d='Shop.Theme.Global'}</p>
