...
<div class="col-auto">
	<div class="user-info btn-group">
			<a href="#" class="account" data-toggle="dropdown" data-display="static">SIGN IN</a>
      {if $logged}
			<div id="login" class="dropdown-menu user-info-sidebar user-info-content{if $gdzSetting.customersignin_class} {$gdzSetting.customersignin_class}{/if}">
