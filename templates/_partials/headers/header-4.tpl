...
<div id="header-top" class="header-top">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="layout-column col col-center">
...
<div class="header-bottom {if $gdzSetting.header_sticky == 1} header-sticky{/if}{if ($gdzSetting.header_sticky == 1) && ($gdzSetting.header_sticky_effect != '')} {$gdzSetting.header_sticky_effect}{/if}">
    <div class="container">
