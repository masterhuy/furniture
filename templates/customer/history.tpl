          ...
          {foreach from=$orders item=order}
            <tr>
              ...
              <td class="text-center order-actions">
                <a href="{$order.details.details_url}" data-link-action="view-order-details" class="btn">
                  {l s='Details' d='Shop.Theme.Customeraccount'}
                </a>
                {if $order.details.reorder_url}
                  <a href="{$order.details.reorder_url}" class="btn">{l s='Reorder' d='Shop.Theme.Actions'}</a>
                {/if}
              </td>
            </tr>
          {/foreach}
